...
//
	...
	@Override
	public Page<ItemOfClothing> findAll(Pageable pageable,ItemOfClothingFilter filter) {
		return itemOfClothingDao.findAll(new ItemOfClothingSpecification(filter), pageable);
	}
